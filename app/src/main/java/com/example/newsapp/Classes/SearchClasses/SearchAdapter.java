package com.example.newsapp.Classes.SearchClasses;
...
public class SearchAdapter extends BaseAdapter implements Filterable {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        SearchAdapter.SuggestionsViewHolder viewHolder;

        if (convertView == null) {
            convertView = inflater.inflate(R.layout.suggest_item, parent, false);
            viewHolder = new SearchAdapter.SuggestionsViewHolder(convertView);
            convertView.setTag(viewHolder);
        } else {
            viewHolder = (SearchAdapter.SuggestionsViewHolder) convertView.getTag();
        }
